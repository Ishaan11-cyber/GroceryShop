    ...
    return (
        <div className='relative'>
            ...
            <div className='flex items-center mt-6 font-medium' >
                <Link
                    to={"/products"}
                    className='group flex justify-center items-center gap-2 px-8 py-3 bg-green-500 hover:bg-green-600 transition rounded-md text-white font-semibold cursor-pointer shadow-md'
                >
                    Shop now
                    <img
